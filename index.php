...
<html lang="en">
	...
	<body>
						...
						<nav class="navbar navbar-expand-lg ">
							...
							<div class="collapse navbar-collapse" id="navbarSupportedContent">
								<ul class="navbar-nav ml-auto ">
									...
									<li class="">
										<a class="nav-link cus-a" href="#about-us">About Us</a>
									</li>
					...
					<div class="row">
						<div class="col-md">
							<div class="banner_content">
								<h1>Unlock Legal Solutions, Anytime, Anywhere!</h1>
								<a href="lawyers.php"><button class="btn-lg cusbutton">Find Lawyers</button></a><!--lawyers.html page-->
							</div>
		...
		<section class="aboutus">
			<div class="container">
				<div class="row">
					<div id="about-us" class="col-md-12 ml-auto">
						<h1>About US</h1>
						<p>Welcome to Proctor Advocate, your trusted platform for connecting legal professionals with clients in need of legal assistance. At Proctor Advocate, we believe that everyone deserves access to quality legal services, and we're committed to making the process of finding legal representation easier, more efficient, and more transparent for both lawyers and clients.</p>
						<h2>Our Contact details </h2>
						<h4>Address - K K Wagh Institute of Engineering Education & Research, Nashik</h4>
						<h4>Contact no. - +91 8390521455 </h4>
					</div>
