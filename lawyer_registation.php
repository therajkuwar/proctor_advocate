<header class = "bg-success">
	...
	<script>
		function MySucessFn(){
			swal({
				title: "Dear Lawyer... Your Registration Successfully Completed! Please Wait for Approval.",
				text: "",
				type: "success",
		...
		function MyCheckFn(){
			swal({
				title: "Sorry, Lawyer! This email already exists. Please fill out the form again.",
				text: "",
				type: "warning",
