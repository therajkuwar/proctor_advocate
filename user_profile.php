				...
				<div class="d-flex" id="wrapper">
					...
					<section class="editprofile">
						<?php if(isset($_GET['ok'])){
							...
							<strong>Sucessfully!</strong> updated your Profile.
							</div>";
						}?>
						<?php
									...
									<div class="form-row">
										...
										<div class="form-group col-md-3">
											...
											<select id="city" name="city" class="form-control">
												...
												<option value="Ahmednagar" <?php if ($row['city']=='Ahmednagar'){echo "selected";}?>>Ahmednagar</option>
																	<option value="Pune" <?php if ($row['city']=='Pune'){echo "selected";}?>>Pune</option>
																	<option value="Amravati" <?php if ($row['city']=='Amravati'){echo "selected";}?>>Amravati</option>
																	...
																	<option value="Jalgaon" <?php if ($row['city']=='Jalgaon'){echo "selected";}?>></option>
											</select>
										</div>
										<div class="form-group col-md-3">
