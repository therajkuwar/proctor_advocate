<header>
	...
	<script>
		function MySucessFn(){
			swal({
				title: "Dear User... Your Registration Successfully Completed! Please Check Your Email.",
				text: "",
				type: "success",
		...
		function MyCheckFn(){
			swal({
				title: "Sorry, User! This email already exists. Please fill out the form again.",
				text: "",
				type: "warning",
